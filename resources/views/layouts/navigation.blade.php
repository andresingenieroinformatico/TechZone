<nav x-data="{ open: false }" class="glass border-b border-gray-100 dark:border-gray-800 sticky top-0 z-40">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                ...
                <a href="{{ route('cart.index') }}" class="relative p-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 transition-colors">
                    ...
                    @auth
                        ...
                        @if($cartCount > 0)
                            <span class="absolute top-0 right-0 bg-blue-600 text-white text-[10px] font-black w-4 h-4 rounded-full flex items-center justify-center border-2 border-white dark:border-gray-800">{{ $cartCount }}</span>
                        @endif
                    @endauth
                </a>
                ...
                @else
                    <div class="flex items-center gap-4">
                        ...
                        <a href="{{ route('register') }}" class="btn-primary py-1.5 px-4 text-xs">Unirse</a>
                    </div>
                @endauth
            </div>
