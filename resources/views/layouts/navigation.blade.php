        ...
        <div class="flex items-center justify-between h-16 gap-4 sm:gap-8">
            ...
            <div class="shrink-0 flex items-center">
                <a href="/" class="flex items-center gap-2">
                    <div class="w-10 h-10 bg-[#3483fa] rounded-lg flex items-center justify-center text-white shadow-sm">
                        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                    </div>
                    <span class="text-2xl font-black text-[#333] tracking-tighter hidden sm:block">Tech<span class="text-[#3483fa]">Zone</span></span>
                </a>
            </div>
            ...
            <div class="flex items-center gap-2 sm:gap-4">
                ...
                @auth
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="hidden sm:inline-flex items-center px-1 py-2 border-none text-sm font-medium rounded-md text-[#333] hover:opacity-70 transition-opacity">
                ...
                @else
                    <div class="hidden sm:flex items-center gap-4 text-sm font-medium text-[#333]">
